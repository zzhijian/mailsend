                            ...
                            <tr>
                                <td>
                                    <table width="100%"  cellspacing="0" cellpadding="0" align="center" style="padding:0px">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <span class="maintitle" style="color:#f46159;text-align: center;">Cart Notification statistics</span>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <table width="100%"  cellspacing="0" cellpadding="0" align="left" style="padding:0px">
                                        ...
                                        <tr>
                                            <td>
                                                <p class="maincontent">Users receive our messages are: <span style="color:#f46159;"><?php echo $content ?></span></p>
                                                <p class="maincontent">The total number of emails sent to is:<?php echo $count ?></p>
                                            </td>
                                        </tr>
