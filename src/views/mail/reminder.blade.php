...
<head>
    ...
    <title>Reset Your PatPat Password</title>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" align="left" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <table width="100%"  cellspacing="0" cellpadding="0" align="left" style="padding:20px 35px; border-bottom:1px solid #f1f3f2;">
                                            <tbody>
                                                <tr>
                                                    <td align="left">
                                                        <span class="maintitle" style="color:#444;font-size:20px;">Reset Your PatPat Password</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p class="maincontent">Here is your code: <span style="color:#f46159;">{{ $token }}.</span></p>
                                                        <p class="maincontent">Please enter this code in the login password section to reset your password. Thank you for shopping with PatPat.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p class="maincontent" style="font-size:12px;color:#a2abad;">
                                                            If you have any questions or did not make this request,
        ...
        <tr>
            <td>
                <table align="center"  style="font-size:14px;">
                    ...
                    <tr>
                        <td align="center" style="color:#aaaeaf;">Pleas do not reply to this message.</td>
                    </tr>
                </table>
            </td>
        </tr>
